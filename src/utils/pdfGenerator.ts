...
export async function generatePdfReport(params: {
  ...
  const advisoryText =
    species.category === 'aquatic'
      ? 'Distribute floating pellets evenly across surface calm spots. Continuously monitor feed appetite to prevent bottom sinking and preserve dissolved oxygen (DO > 5.0 mg/L).'
